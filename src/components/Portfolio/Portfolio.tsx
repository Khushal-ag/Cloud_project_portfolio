      ...
      <ScrollAnimation animateIn="flipInX">
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              <h3>Wofi Emoji</h3>
              <p> A simple script that uses wofi to search for emojis and copy them to the clipboard.
              </p>
            </div>
            <footer>
              <ul className="tech-list">
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              <h3>Heavens Anime</h3>
              <p>It's a in-development anime streaming website that i'm working on. its a group project btw and usage external api's to fetch anime data.
              </p>
            </div>
            <footer>
              <ul className="tech-list">
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              <h3>To_Do_List</h3>
              <p>A simple To Do list i made during my webd learning period. 
              </p>
            </div>
            <footer>
              <ul className="tech-list">
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <svg width="50" xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 24 24" fill="none" stroke="#23ce6b " stroke-width="1" stroke-linecap="round" stroke-linejoin="round" ><title>Folder</title><path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"></path></svg>
            <div className="project-links">
              <a href="https://github.com/Khushal-ag/test_repo" target="_blank" rel="noreferrer">
                <img src={githubIcon} alt="Visitor site" />
              </a>
              <a href="http://herokuapp.com" target="_blank" rel="noreferrer">
